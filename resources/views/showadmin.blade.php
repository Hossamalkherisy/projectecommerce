...
<button type="button" class="btn btn-info  btn-lg btn_admin"> Add Category   </button>
</div>
<div class="col-lg-4 col-md-6 mb-4">
<button type="button" class="btn btn-info  btn-lg btn_admin">Eidte Category </button>
</div>
<div class="col-lg-4 col-md-6 mb-4">
<button type="button" class="btn btn-danger btn-lg btn_admin">Delete Category</button>
</div>

</div>
<div class="row">
       <div class="col-lg-4 col-md-6 mb-4">
<button type="button" class="btn btn-info  btn-lg btn_admin"> Add Product   </button>
</div>
<div class="col-lg-4 col-md-6 mb-4">
<button type="button" class="btn btn-info  btn-lg btn_admin">Eidte Product </button>
</div>
<div class="col-lg-4 col-md-6 mb-4">
<button type="button" class="btn btn-danger btn-lg btn_admin">Delete Product</button>
</div>
